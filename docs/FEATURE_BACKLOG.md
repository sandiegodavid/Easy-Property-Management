...
The status column shows delivery progress. `✅ Done` means the item is implemented and verified; a blank status means it has not yet been completed. Completed dependencies appear as green badges in the dependency column.
