...
The additional backend prerequisites are planned capabilities, not existing implementations: TASK-002 adds waiting/follow-up semantics; OPS-001 adds coverage/review provenance, draft recovery, preferences, and bounded search; LEGAL-001 and HOA-001 own their distinct records and typed file/task/communication links. Finance remains authoritative for paid amounts, Providers for reusable provider identity, and source domains for lifecycle. Case closure cannot silently alter occupancy, financial records, or repair state.
