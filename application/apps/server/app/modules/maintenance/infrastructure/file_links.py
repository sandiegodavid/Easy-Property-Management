...
from .sqlalchemy_models import MaintenanceIssueModel,MaintenanceAppointmentModel,MaintenanceCostContextModel
class SQLiteMaintenanceFileLinkOperations:
 ...
 def exists(self,connection,entity_type,entity_id):
  model={"maintenance_issue":MaintenanceIssueModel,"maintenance_appointment":MaintenanceAppointmentModel,"maintenance_cost_context":MaintenanceCostContextModel}[entity_type]
