...
class QuoteInput(Contract): providerPartyId:UUID; label:str=Field(min_length=1,max_length=200); scopeSummary:str=Field(min_length=1,max_length=4000); amount:str; receivedOn:date; validThrough:date|None=None; termsNotes:str|None=Field(None,max_length=4000); replacesQuoteId:UUID|None=None; idempotencyKey:UUID
