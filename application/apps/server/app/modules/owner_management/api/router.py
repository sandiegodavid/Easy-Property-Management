...
class ConcernCreateRequest(Contract):
    ...
    historicalSelectionConfirmed:bool=False; historicalSelectionReason:str|None=Field(default=None,max_length=1000); duplicateConfirmed:bool=False; duplicateReason:str|None=Field(default=None,max_length=1000); replacesConcernId:UUID|None=None; followUp:FollowUpRequest|None=None
...
class ConcernPage(Contract): items:list[ConcernResponse]; nextCursor:str|None=None
...
def build_router(service:OwnerConcernService,runtime:WorkspaceRuntime)->APIRouter:
    ...
    @router.post("",response_model=ConcernResponse,dependencies=[Depends(ready)])
    ...
    @router.patch("/{concern_id}",response_model=ConcernResponse,dependencies=[Depends(ready)])
    ...
    @router.post("/{concern_id}/start",response_model=ConcernResponse,dependencies=[Depends(ready)])
    ...
    @router.post("/{concern_id}/resolve",response_model=ConcernResponse,dependencies=[Depends(ready)])
    ...
    @router.post("/{concern_id}/dismiss",response_model=ConcernResponse,dependencies=[Depends(ready)])
    ...
    @router.post("/{concern_id}/reopen",response_model=ConcernResponse,dependencies=[Depends(ready)])
    ...
    @router.post("/{concern_id}/follow-ups",response_model=ConcernResponse,dependencies=[Depends(ready)])
