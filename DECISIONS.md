...
| Use a machine-local workspace locator and a versioned non-secret workspace manifest. | Agreed | The locator identifies the selected external folder without putting user data in Git; the manifest gives the portable workspace a stable identity and format version. |
